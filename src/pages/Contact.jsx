...
export default function Contact() {
  ...
  return (
    ...
    <div >
      {/*overlay*/}      
      <div className='flex items-center justify-center mb-12 bg-inherit bg-center bg-cover contact-bgimg h-screen hidden sm:flex'>
    ...
    <div >
      ...
      <div className='flex items-center justify-center mb-5 bg-inherit bg-center bg-cover contact-bgimg h-screen sm:hidden'>
        <div className='absolute top-0 left-0 h-screen right-0 bottom-0 bg-black/60 z-[2]'/>
          <div className='z-[3] mb-[6rem]'>
            <div className=' text-white mb-[2.5rem] ml-[2.5rem] mr-[2rem]'>
      ...
      <form /*onSubmit={handleSubmit}*/ className="rounded-3xl shadow-xl sm:flex flex-col px-[45px] py-[40px] bg-amber-800/40 z-[3] ml-[2rem] mr-[2rem]">
        ...
        <input type="text" value={fullname} onChange={(e) => {setFullname(e.target.value);}} name="fullname" className="bg-transparent border-b py-3 pl-2 pr-1 focus:outline-none focus:rounded-md focus:ring-1 ring-amber-700/40 font-light text-gray-50" />

        {/**Email */}
        <label for="email" className="flex text-gray-50 font-light">E-mail<span className="text-red-500">*</span></label>
        <input  type="email" name="email" value={email} onChange={(e) => {setEmail(e.target.value);}} className="bg-transparent border-b py-3 pl-2 pr-1 focus:outline-none focus:rounded-md focus:ring-1 ring-amber-700/40 font-light text-gray-50" />
        ...
        <input type="text" name="subject" value={subject} onChange={(e) => { setSubject(e.target.value); }} className="bg-transparent border-b py-3 pl-2 pr-1 focus:outline-none focus:rounded-md focus:ring-1 ring-amber-700/40 font-light text-gray-50" />
        ...
        <textarea name="message" value={message} onChange={(e) => { setMessage(e.target.value); }} className="bg-transparent border-b py-3 pr-8 pl-2 focus:outline-none focus:rounded-md focus:ring-1 ring-amber-700/40 font-light text-gray-50"></textarea>

        {/**Send */}
        <div className="flex flex-row items-center justify-start">
          <button type='submit' className="px-10 mt-2 py-2 bg-amber-800/60 text-gray-50 font-light rounded-md text-lg flex flex-row items-center raleway">
            Send
          </button>
        </div>
        </form>                         
